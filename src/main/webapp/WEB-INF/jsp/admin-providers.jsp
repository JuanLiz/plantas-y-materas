...
<head>
        ...
        <title>Gestión de proveedores - Plantas y Materas</title>
  ...
  <div class="d-flex">
    ...
    <div class="sidebar p-3 bg-light fw-bold" style="width: 280px;">
      <ul class="nav mb-auto">
        ...
        <li>
          <a href="admin-providers" class="nav-link active">
        ...
        <section class="mainc">
            ...
            <div class="row pb-5 align-items-center">
              ...
              <div class="col-md-4 g-0 my-auto">
                ...
                <div class=" d-flex me-2 justify-content-end">
                  <img class="big" src="img/undraw_logistics.svg" alt="" width="300" >
                </div>
              </div>
            </div>
			<!-- Notifications -->
            <c:if test="${successp}">
				<div class="alert alert-success alert-dismissible d-flex align-items-center fade show" role="alert">
					...
					<strong>${providertype} tuvo éxito</strong>
            ...
            <c:if test="${errorp}">
				<div class="alert alert-danger alert-dismissible d-flex align-items-center fade show" role="alert">
					...
					<strong>Hubo un error en <strong class="text-lowercase">${providertype}</strong>.</strong> 
            ...
            <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form action="create-providers" method="POST" class="needs-validation" novalidate autocomplete="off" modelAttribute="create_provider">                                     
                    <!--Form fields-->
                    <div class="modal-body">
                      <!--ID-->
                      <div class="form-floating mb-3">
                        <input type="number" class="form-control align-middle" id="idproviders" name="idproviders" placeholder="70041053" required>
                        <label for="floatingId">NIT</label>
                        <div id="emailHelp" class="form-text">Este dato no se podrá cambiar mas adelante</div>
                        <div class="invalid-feedback">
                          Proporciona el NIT del proveedor
                        </div>
                      </div>
                      <!--Name-->
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="name" name="name"  placeholder="John Doe" required>
                        <label for="floatingName">Nombre del proveedor</label>
                        <div class="invalid-feedback">
                          Proporciona el nombre del proveedor
                        </div>
                      </div>
                      <!--City-->
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="city" name="city" placeholder="Bogotá" required>
                      ...
                      <!--Address-->
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="address" name="address"  placeholder="Av. 7 # 15-27" required>
            ...
            <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form action="update-providers" method="POST" class="needs-validation" novalidate autocomplete="off" modelAttribute="update_provider">                                     
                    <!--Form fields-->
                    <div class="modal-body">
                      <!--ID-->
                      <div class="form-floating mb-3">
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form action="delete-providers" method="POST" class="needs-validation" novalidate autocomplete="off" modelAttribute="delete_provider">                                     
                    <!--Form fields-->
                    <div class="modal-body">
                      <!--ID-->
                      <div class="form-floating mb-3">
